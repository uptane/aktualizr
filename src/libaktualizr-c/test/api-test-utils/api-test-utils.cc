...
static std::string serverAddress;                      // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
static std::unique_ptr<boost::process::child> server;  // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
static std::unique_ptr<TemporaryDirectory> temp_dir;   // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
